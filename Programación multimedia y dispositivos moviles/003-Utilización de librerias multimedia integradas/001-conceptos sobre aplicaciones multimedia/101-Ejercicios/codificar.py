...
def encode_video(input_video, output_dir, width, height, quality_name):
    """Codifica el video a una resolución específica"""
    input_path = Path(input_video)
    output_filename = f"{input_path.stem}_{quality_name}{input_path.suffix}"
    ...
    try:
        subprocess.run(cmd, check=True, capture_output=True)  # capture_output silencia la salida
